...
if [ -z "$@" ]; then
    JAZZY_ARGS="--theme fullwidth --author Ren&eacute;&nbsp;Hexel --author_url https://experts.griffith.edu.au/9237-rene-hexel --github_url https://github.com/rhx/Swift$Pkg --github-file-prefix https://github.com/rhx/Swift$Pkg/tree/generated --root-url http://rhx.github.io/Swift$Pkg/ --output docs"
fi
